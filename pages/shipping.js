  ...
  return (
    <Layout title="Endereço da Entrega">
      ...
      <div className="card w-full">
        ...
        >
          <h1 className="mb-4 text-5xl text-center text-blue-800">
            Endereço
          </h1>
          <div className="mb-4 grid col-span-1">
            <label className="text-xl text-blue-800" htmlFor="name">
              Nome completo
            </label>
            <input
              ...
              {...register("name", {
                ...
                minLength: {
                  value: 4,
                  message: "Por favor, digite também seu sobrenome.",
                },
              })}
            />
            {errors.name && (
          ...
          <div className="flex gap-10 justify-between">
            <div className="mb-4 grid col-span-1">
              <label className="text-xl text-blue-800" htmlFor="postalCode">
                CEP
              </label>
              <input
                className="form-control block w-full px-4 py-2 text-xl font-normal text-gray-700 bg-white bg-clip-padding border border-solid border-gray-300 rounded transition ease-in-out m-0 focus:text-white focus:bg-blue-800 focus:border-blue-600 focus:outline-none"
                ...
                {...register("postalCode", {
                  ...
                  minLength: {
                    value: 8,
                    message: "O CEP deverá conter no mínimo 8 números.",
                  },
                  maxLength: {
                    value: 10,
                    message: "O CEP deverá conter apenas 8 números.",
                  },
                })}
              />
              {errors.postalCode && (
            ...
            <div className="mb-4 grid col-span-1">
              <label className="text-xl text-blue-800" htmlFor="number">
                Número
              </label>
              <input
                className="form-control block w-full px-4 py-2 text-xl font-normal text-gray-700 bg-white bg-clip-padding border border-solid border-gray-300 rounded transition ease-in-out m-0 focus:text-white focus:bg-blue-800 focus:border-blue-600 focus:outline-none"
                ...
                {...register("number", {
                  ...
                  minLength: {
                    value: 1,
                    message:
                      "O número informado deve ser maior que 1, caso não possua número, digite 0",
                  },
                })}
              />
              {errors.number && (
          ...
          <div className="flex gap-10  justify-between">
            <div className="mb-4 grid col-span-1">
              <label className="text-xl text-blue-800" htmlFor="address">
                Rua
              </label>
              <input
                className="form-control block w-full px-4 py-2 text-xl font-normal text-gray-700 bg-white bg-clip-padding border border-solid border-gray-300 rounded transition ease-in-out m-0 focus:text-white focus:bg-blue-800 focus:border-blue-600 focus:outline-none"
            ...
            <div className="mb-4 grid col-span-1">
              <label className="text-xl text-blue-800" htmlFor="neighborhood">
                Bairro
              </label>
              <input
                className="form-control block w-full px-4 py-2 text-xl font-normal text-gray-700 bg-white bg-clip-padding border border-solid border-gray-300 rounded transition ease-in-out m-0 focus:text-white focus:bg-blue-800 focus:border-blue-600 focus:outline-none"
          ...
          <div className="flex gap-10 justify-between">
            <div className="mb-4 grid col-span-1">
              <label className="text-xl text-blue-800" htmlFor="city">
                Cidade
              </label>
              <input
                className="form-control block w-full px-4 py-2 text-xl font-normal text-gray-700 bg-white bg-clip-padding border border-solid border-gray-300 rounded transition ease-in-out m-0 focus:text-white focus:bg-blue-800 focus:border-blue-600 focus:outline-none"
            ...
            <div className="mb-4 grid col-span-1">
              <label className="text-xl text-blue-800" htmlFor="state">
                UF
              </label>
              <input
                className="form-control block w-full px-4 py-2 text-xl font-normal text-gray-700 bg-white bg-clip-padding border border-solid border-gray-300 rounded transition ease-in-out m-0 focus:text-white focus:bg-blue-800 focus:border-blue-600 focus:outline-none"
                ...
                {...register("state", {
                  ...
                  minLength: {
                    value: 2,
                    message:
                      "Digite a UF do estado no formato válido. Ex.: SP.",
                  },
                  maxLength: {
                    value: 3,
                    message:
          ...
          <div className="mb-4 text-end">
            <button className="primary-button border border-solid border-gray-300">Avançar</button>
          </div>
        </form>
      </div>
    </Layout>
