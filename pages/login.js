                                ...
                                <div className="flex justify-between items-center mb-6">
                                    <div className="form-group form-check">
                                        <input
                                            ...
                                            id="checkbox"
                                        />
                                        <label className="form-check-label inline-block text-gray-800" for="checkbox">Lembrar-me</label>
                                    </div>
                                    <p className="text-md font-semibold mt-2 pt-1 mb-0">
                                        Não possui uma conta?
                                        <a
                                            href="#!"
                                            className="text-red-600 hover:text-red-700 focus:text-red-700 transition duration-200 ease-in-out">Registre-se</a>
                                    </p>
                                </div>
