                            ...
                            <tbody>
                                {orders.map((order) => (
                                    <tr key={order._id} className="border-t-2 text-xl border-t-blue-800">
                                        ...
                                        <td className="p-5 text-center">{order.createdAt.substring(8, 10)}/{order.createdAt.substring(5, 7)}/{order.createdAt.substring(0, 4)}</td>
                                        <td className="p-5 text-center">R$ {order.descount}</td>
                                        <td className="p-5 text-center">
                                            {
                                                order.isPaid
                                                    ? <span className='bg-green-200 p-2 rounded-xl'>{order.paidAt.substring(8, 10)}/{order.paidAt.substring(5, 7)}/{order.paidAt.substring(0, 4)}</span>
